/*  $Id: psiblast_args.cpp 500404 2016-05-04 14:59:01Z camacho $
 * ===========================================================================
 *
...
CPsiBlastAppArgs::CPsiBlastAppArgs()
{
    ...
    arg.Reset(new CProgramDescriptionArgs(kProgram,
                                          "Position-Specific Iterated BLAST with extended blocks (NCBI PSI-BLAST arranged by T.Oda)"));//Oda modified
