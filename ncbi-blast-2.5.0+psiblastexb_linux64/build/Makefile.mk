...
#
# srcdir = /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++/src/build-system
...
top_srcdir     = /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++
abs_top_srcdir = /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++
build_root     = /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++/ReleaseMT
builddir       = /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++/ReleaseMT/build
status_dir     = /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++/ReleaseMT/status
...
RMDIR    = /bin/rm -rf
COPY     = /bin/cp -p
BINCOPY  = /bin/sh $(top_srcdir)/scripts/common/impl/if_diff.sh "/bin/ln -f"
TOUCH    = /bin/touch
MKDIR    = /bin/mkdir
BINTOUCH = $(TOUCH)
LN_S     = /bin/ln -s
...
CONF_CC     = /opt/rh/devtoolset-2/root/usr/bin/gcc  -std=gnu11 -fgnu89-inline
CONF_CXX    = /opt/rh/devtoolset-2/root/usr/bin/g++  -std=gnu++11
CONF_CPP    = gcc -E
CONF_CXXCPP = /opt/rh/devtoolset-2/root/usr/bin/g++  -std=gnu++11 -E
CONF_AR     = ar cr
CONF_RANLIB = ranlib
CONF_LINK   = $(CC)
CONF_C_LINK = $(CC)
...
CONF_CFLAGS   =  -Wall -Wno-format-y2k  -pthread -fopenmp -O2 
CONF_CXXFLAGS =  -Wall -Wno-format-y2k  -pthread -fopenmp -O2 
...
CONF_APP_LDFLAGS = 
CONF_DLL_LDFLAGS =  $(DLL_UNDEF_FLAGS)
CONF_LIBS     =  -lrt -ldl /opt/rh/devtoolset-2/root/usr/lib/gcc/x86_64-redhat-linux/4.8.2/libstdc++.a -lm  -lpthread
...
FAST_CFLAGS   =   -Wall -Wno-format-y2k  -pthread -fopenmp   -O3 -finline-functions -fstrict-aliasing -fomit-frame-pointer
FAST_CXXFLAGS =   -Wall -Wno-format-y2k  -pthread -fopenmp   -O3 -finline-functions -fstrict-aliasing -fomit-frame-pointer
...
### Extra macro definitions from /root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++/src/algo/blast/Makefile.blast_macros.mk

#line 1 "/root/blasttest/source_upload/ncbi-blast-2.5.0+-src/c++/src/algo/blast/Makefile.blast_macros.mk"
#################################
